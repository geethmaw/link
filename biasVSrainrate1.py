...
for x in range(n,n+1):  #month
    x_temp = x
    for i in range(m,m+10): #date ******February
        i_temp = i
                    ...
                    for l in range(1,360): #lons(1,360)
                        ...
                        if cygn>0 and amsr>0:
                            ...
                            if t<=1 and rr>0:
                              ...
                              cyg.append(cygn[0])
                              am.append(amsr[0])
                              # np.savez_compressed('/glade/work/geethma/research/npzfiles1/u10_'+f'{x_temp:02d}'+f'{i_temp:02d}'+'2019', cw=cyg, aw=am, b=bias, ar=r) #u10_monthdateyear.npz
    np.savez_compressed('/glade/work/geethma/research/npzfiles1/u10_'+f'{x_temp:02d}'+f'{i_temp:02d}'+'2019', cw=cyg, aw=am, b=bias, ar=r) #u10_monthdateyear.npz
