...
# @Date:   2022-06-27T11:16:13-06:00
# @Last modified by:   geethmawerapitiya
# @Last modified time: 2022-06-28T01:01:19-06:00
...
for i in range(l,m):
    ...
    plot_W = locals()['plot_sfcWind'+str(i+1)].flatten()
    ...
    std_dev = np.nanstd(bin_means)
    plt.fill_between(bin_means_x, bin_means-std_dev, bin_means+std_dev, alpha=0.2)
...
plt.savefig('../figures/interp_SST_U10vsM_'+str(latr1)+'N to '+str(latr2)+'N_800theta.png')
