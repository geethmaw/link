...
fn = glob.glob('/glade/work/geethma/research/npzfilesn/2019/january2/u10*npz')
fn = np.array(fn)
arf=[]
bf = []
######
...
plt.text('Average Bias = '+str(np.nanmean(bf)))
# plt.show()
plt.savefig('/glade/work/geethma/research/npzfilesn/2019/january2/plots/plot_biasVSrr.png')
