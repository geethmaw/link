...
def main(day):
    ...
    # fn      = '/glade/work/geethma/research/data_cygnss/2019/cyg.ddmi.s2019'+f'{month:02d}'+f'{day:02d}'+'-003000-e2019'+f'{month:02d}'+f'{day:02d}'+'-233000.l3.grid-wind.a30.d31.nc'
                ...
                for l in range(1,360): #lons(1,360)
                    ...
                    if cygn>0 and amsr>0:
                        ...
                        if t<=1 and rr>0:
                          ...
                          cyg.append(cygn[0])
                          am.append(amsr[0])
                          # np.savez_compressed('/glade/work/geethma/research/npzfilesn/u10_01'+f'{day:02d}'+'2019', cw=cyg, aw=am, b=bias, ar=r) #u10_monthdateyear.npz
    np.savez_compressed('/glade/work/geethma/research/npzfilesn/u10_01'+f'{day:02d}'+'2019', cw=cyg, aw=am, b=bias, ar=r) #u10_monthdateyear.npz
