...
fn = glob.glob('/glade/work/geethma/research/npzfilesn/2019/january2/u10*npz')  #u10*npz
fn = np.array(fn)
awf=[]
cwf = []
bf = []
...
plt.ylabel('Bias (m/s)')
plt.savefig('/glade/work/geethma/research/npzfilesn/2019/january2/plots/plot_biasVScygnsswind.png') #/plots
