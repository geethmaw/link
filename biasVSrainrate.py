...
#############2019 data##########
for x in range(1,2):  #month
    x_temp = x
    for i in range(1,4): #date upto 28th
        i_temp = i
    ...
    # ##############
        ...
        am = []
        cyg = []
        for i in range(0,10): #time_cyg (0,24)
            for j in range(1,3): #pass (1,3)
                for k in range(0,40): #lats(-39,40)
                    for l in range(260,360): #lons(1,360)
                        pt  = [i,k,l]
                        pta = [j,k,l]
                        ...
                        if cygn>0 and amsr>0:
                            ...
                            if t<=1 and rr>0:
                              ...
                              cyg.append(cygn[0])
                              am.append(amsr[0])
                              np.savez_compressed('/glade/work/geethma/research/npz/u10_'+f'{x_temp:02d}'+f'{i_temp:02d}'+'2019', cw=cyg, aw=am, b=bias, ar=r) #u10_monthdateyear.npz
